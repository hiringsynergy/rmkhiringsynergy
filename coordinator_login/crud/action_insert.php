            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <form action="action_insert.php" method="get">
<!--                            <label for="form-field-select-3">Year of Graduation</label>-->
<!---->
<!--                            <br >-->
<!--                            <br >-->
<!--                            -->
<!---->
<!---->
<!--                            <select class="chosen-select form-control" id="form-field-select-3" name="select" data-placeholder="Select year of graduation...">-->
<!--                               -->
<!--                                --><?php
//
//                                if(isset($_GET['insert_year'])) {
//
//                                    $value = $_GET['insert_year'];
//
//                                    $connect = mysqli_connect("localhost", "root", "", "rmd_database");
//                                    $query_insert = "SELECT * FROM table_map WHERE table_value =$value ";
...
//
//
//                                    $query_insert1 = "SELECT * FROM table_map";
//                                    $result_insert1 = mysqli_query($connect, $query_insert1);
//                                    while ($row1 = mysqli_fetch_assoc($result_insert1)) {
//
//
//
//                                        if($row1['table_value']!=$value) {
//
//
//                                            ?>
<!---->
<!---->
<!--                                            <option value="--><?php //echo $row1['table_name'] ?><!--">--><?php //echo $row1['table_value'] ?><!--</option>-->
<!--                                            --><?php
//                                        }
//
//                                    }
