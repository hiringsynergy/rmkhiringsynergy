		...
		<div class="row">
			...
			<div class="col-xs-4 col-sm-3">
											<div>
														...
														<select class="chosen-select form-control" id="form-field-select-3" name="company_id" data-placeholder="Choose a Company...">
																<option value="">  </option>
		...
		<div class="row">
					<div class="col-xs-7 col-sm-5">
									<h5><label class="control-label bolder orange" for="form-field-1">Venue</label></h5>
											<input type="text" id="form-field-1" name="venue" placeholder="Enter Venue" class="col-xs-12" />
					</div>
					<div class="col-xs-7 col-sm-5">
									<h5><label class="control-label bolder orange" for="form-field-1">Joining Location</label></h5>
											<input type="text" id="form-field-1" name="joining_location" placeholder="Enter Location" class="col-xs-12" />
					</div>
		</div>
                    <div class="space-10"></div>
                    <div class="row">
		...
		<div class="row">
					<div class="col-xs-7 col-sm-5">
									<div><h5><label class="control-label bolder orange" for="form-field-11">Job Description</label></h5>
											<textarea id="form-field-11" name="job_description" rows="7" class="autosize-transition form-control" placeholder="Type something about job....."></textarea>
									</div>
					</div>
					<div class="col-xs-7 col-sm-5">
									<div><h5><label class="control-label bolder orange" for="form-field-11">Skill Set</label></h5>
											<textarea id="form-field-11" rows="7" name="skill_set" class="autosize-transition form-control" placeholder="Type something about Skill Set....."></textarea>
									</div>
					</div>
		</div>
		<div class="row">
					<div class="col-xs-7 col-sm-5">
									<h5><label class="control-label bolder orange" for="form-field-1">Salary(per Annum)</label></h5>
											<input type="text" id="form-field-1" name="salary" placeholder="Enter Salary" class="col-xs-12" />
					</div>
					<div class="col-xs-7 col-sm-5">
									<h5><label class="control-label bolder orange" for="form-field-1">Job Type</label></h5>
											<select class="col-xs-7 chosen-select form-control" name="job_type" id="form-field-select-3" placeholder="select job type...">
