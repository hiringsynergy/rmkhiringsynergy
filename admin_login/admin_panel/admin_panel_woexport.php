    ...
    <script type="text/javascript">
        ...
        function showStudent(str) {
            if (str == "") {
                ...
                xmlhttp.open("GET","../admin_panel/getstudent.php?id="+str,true);
                xmlhttp.send();
            }
        }
...
if(isset($_GET['delete'])){
    ...
    header('Location : ../admin_panel/admin_panel_woexport.php ');
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="myfont">
                                    Switch to Export Table

                                </div>
                                <div class="col-xs-3 test"  >
                                    <label>
                                        <input align="right" name="switch-field-1" id="chk1" class="ace ace-switch ace-switch-7" type="checkbox" />
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <div class="action-buttons">
                                                        <a href="#" class="green bigger-140 show-details-btn" id="show-details-<?php echo $roll ?>" title="Show Details" onclick="myclick(<?php $_SESSION['show_roll']=$roll ?>)">
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        ...
                                                        <a class="red" href="../admin_panel/admin_panel_woexport.php?delete=<?php echo $roll ?>">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-2">
                                                                <div class="text-center">
                                                                    <img height="130" class="thumbnail inline no-margin-bottom center" alt="Domain Owner's Avatar" src="../../student_login/images/<?php echo $pic ?>" />
                                                                    <br />
                                                                    <div class="width-300 label label-info label-xlg col-md-offset-12 col-lg-push-1 arrowed-in arrowed-in-right center">
                                                                        <div class="inline position-relative col-xs-6  center">
                                                                            <a class="user-title-label center" href="#">
...
<!--                                                                    </div>-->
                                                                    ...
                                                                    <div class="profile-info-row">
                                                                        <div class="profile-info-name"> 10th Percent </div>
                                                                    ...
                                                                    <div class="profile-info-row">
                                                                        <div class="profile-info-name"> 12th Percent </div>
                                                            ...
                                                            <div class="col-xs-12 col-sm-3">
                                                                <div class="space visible-xs"></div>
                                                                <h4 class="header blue lighter less-margin">Send a message to <?php echo $name ?></h4>
