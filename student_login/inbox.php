        ...
        <div id="navbar" class="navbar navbar-default          ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="inbox.php" class="navbar-brand">
                        <small>
                            <i class=""></i>
                            <?php
									...
									<div class="col-xs-12">
										<div class="tabbable">
											<ul id="inbox-tabs" class="inbox-tabs nav nav-tabs padding-16 tab-size-bigger tab-space-1">
												...
												<li>
													<a data-toggle="tab" href="#read" data-target="sent">
														<i class="orange ace-icon fa fa-eye bigger-130"></i>
														<span class="bigger-110">Read</span>
													</a>
												</li>

												<li>
													<a data-toggle="tab" href="#unread" data-target="draft">
														<i class="pink ace-icon fa fa-question bigger-130"></i>
								...
								<div class="hide message-content" id="id-message-content">
									<div class="message-header clearfix">
										<div class="pull-left">
											...
											&nbsp;
											<img class="middle" alt="John's Avatar" src="assets/images/avatars/avatar.png" width="48" />
											&nbsp;
